...
> 适用版本：`0.9.23-1.20.1` · Minecraft 1.20.1 · Capability schema 23 · 网络协议 13
>
...
- `PlayerMysteryData` schema 19 新增按案件 ID 索引的 `case_hypotheses`；当前 schema 23 继续保留，并兼容 schema 20 历史、schema 21 响应、schema 22 联系人记忆与 schema 23 城市班次/暴露。
...
- 371 项 JUnit 覆盖文本消毒、NBT 往返、错误检验、纠正恢复、动态案件复议、样本/并发现场/卷宗/跨日队伍、12 项周指令、组织立场、联系人响应、复议冷却、非法载荷、协议快照、序列 5 仪式、旅行家远门、特性加工/负载、结案扣分和 schema 18→19→20→21→22→23 迁移。
