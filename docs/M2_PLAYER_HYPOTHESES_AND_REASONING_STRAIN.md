...
> 适用版本：`0.9.18-1.20.1` · Minecraft 1.20.1 · Capability schema 23 · 网络协议 12
>
...
- 340 项 JUnit 覆盖文本消毒、NBT 往返、错误检验、纠正恢复、动态案件复议、样本/并发现场/卷宗/跨日队伍、12 项周指令、组织立场、联系人响应、复议冷却、非法载荷、协议快照、结案扣分和 schema 18→19→20→21→22→23 迁移。
...
- 完整发布继续执行 9 项 Forge GameTest、迁移回滚和同一世界双启动专服矩阵。
