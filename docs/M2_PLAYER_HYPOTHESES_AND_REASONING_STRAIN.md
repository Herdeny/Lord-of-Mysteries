...
> 适用版本：`0.9.29-1.20.1` · Minecraft 1.20.1 · Capability schema 29 · 网络协议 13
>
...
- 416 项 JUnit 覆盖文本消毒、NBT 往返、错误检验、纠正恢复、动态案件复议、样本/并发现场/卷宗/跨日队伍、12 项周指令、组织立场、联系人响应、复议冷却、非法载荷、协议快照、序列 5 仪式、最终材料、无面人记录、旅行家双向门、秘偶权威收纳、特性加工/负载/来源审计、结案扣分和 schema 18→29 迁移。
