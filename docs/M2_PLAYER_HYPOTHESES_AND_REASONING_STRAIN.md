...
> 适用版本：`0.9.24-1.20.1` · Minecraft 1.20.1 · Capability schema 24 · 网络协议 13
>
...
- 377 项 JUnit 覆盖文本消毒、NBT 往返、错误检验、纠正恢复、动态案件复议、样本/并发现场/卷宗/跨日队伍、12 项周指令、组织立场、联系人响应、复议冷却、非法载荷、协议快照、序列 5 仪式、旅行家远门、特性加工/负载/来源审计、结案扣分和 schema 18→19→20→21→22→23→24 迁移。
