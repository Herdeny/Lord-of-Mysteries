...
> 适用版本：`0.9.26-1.20.1` · Minecraft 1.20.1 · Capability schema 26 · 网络协议 13
>
...
- 392 项 JUnit 覆盖文本消毒、NBT 往返、错误检验、纠正恢复、动态案件复议、样本/并发现场/卷宗/跨日队伍、12 项周指令、组织立场、联系人响应、复议冷却、非法载荷、协议快照、序列 5 仪式、旅行家持续双向门/命名/权限/黑名单/领地事件、特性加工/负载/来源审计、结案扣分和 schema 18→19→20→21→22→23→24→25→26 迁移。
