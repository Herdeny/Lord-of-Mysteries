...
- 网络协议为 12；14 个固定消息 ID、340 项 JUnit、9 项 Forge GameTest、M1/M2/M3 合同、精确回滚和双启动专服矩阵组成分层门禁。
...
- M3：`planned` 里程碑已预实现五途径序列 6–5 的 10 瓶魔药、20 项能力和 20 项扮演事件；专属晋升仪式、完整能力系统和多人互补尚未完成。
