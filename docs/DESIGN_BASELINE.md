...
- 网络协议为 12；14 个固定消息 ID、260 项 JUnit、6 项 Forge GameTest、精确回滚和双启动专服矩阵组成分层门禁。
...
- M2：当前 `active`。调查板、证据推理、玩家假说、可恢复误判代价、三类八槽位动态案件、案件相关人/受影响者、可视物证、四类封存样本和实体三轮取证已完成；继续扩展角色关系/日程、组织反馈、周级调度、正式城市与长期经济。
