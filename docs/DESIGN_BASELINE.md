...
- 0.9.2 增加 Core/Knowledge/Social/Endgame 四区 dirty mask、生命周期核心摘要和客户端只读缓存；0.9.3 将 Forge GameTest 扩至 5 项。
...
- 网络协议由 7 升至 8；12 个固定消息 ID、202 项 JUnit、5 项 Forge GameTest、精确回滚和双启动专服矩阵组成分层门禁。
...
- M2：当前 `active`。继续建设报社、事务所、警局、调查板、经济和三个动态案件。
