...
- 完整数据为284条，其中实际注册内容为138物品、7方块、16实体；生成数据还包括12个组织、24件封印物、6种天气与12类遭遇，人工条目只补充能力、机制、仪式、世界与状态说明。
...
- 动态卡片必须同步454/26测试、457/1922/802/145资源、138/7/16注册表、164/214内容图和284条图鉴；生成数据必须包含12个组织、24件封印物、6种天气和12类遭遇；
