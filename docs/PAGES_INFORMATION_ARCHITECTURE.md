...
- 完整数据为310条，其中实际注册内容为156物品、7方块、28实体；生成数据还包括12个组织、24件封印物、6种天气与12类遭遇，人工条目只补充能力、机制、仪式、世界与状态说明。
...
- 动态卡片必须同步464/28测试、485/2011/815/163资源、156/7/28注册表、164/214内容图和310条图鉴；生成数据必须包含12个组织、24件封印物、6种天气和12类遭遇；
- 路线首页必须直接显示当前 M5，只有 M6–M12 进入渐进折叠；
