...
0.9.25 从 `ModEntities` 自动加入 `traveler_door`，图鉴增至 189 条唯一记录；旅行家能力、M3 总览、专服验证、schema 和资源条目同步展示 20 秒双向门、主动穿门同意、三档权限、安全落点、失败退款、反回弹、schema 25、384 项 JUnit、15 项 Forge GameTest 与 9 个实体。门命名、黑名单和领地兼容仍明确标为后续边界。
