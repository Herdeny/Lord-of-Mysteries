...
- 完整数据为 190 条，其中实际注册内容为 91 物品、7 方块、9 实体；方块物品与方块按 ID 去重后共有 100 条注册记录，另含随代码同步维护的能力、机制、仪式、组织、世界与状态条目。
...
0.9.25 从 `ModEntities` 自动加入 `traveler_door`，图鉴增至 189 条唯一记录；0.9.26 更新旅行家能力、M3 总览、专服验证、schema 和资源条目。0.9.27 新增“秘偶大师持久编队”机制条目，图鉴增至 190 条，并同步旅行家门主/管理员端点运维、schema 27、397 项 JUnit、17 项 Forge GameTest、1500 对双语键与 593 个静态引用。秘偶收纳/跨维控制、具体领地 Mod 适配器和组织门权限仍明确标为后续边界。
