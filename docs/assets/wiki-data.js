...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:investigation_board", name: "雾都调查板", en: "Mist City Investigation Board",
    summary: "分页展示案件摘要、报酬、步骤、进度、锁定与冷却状态，并由服务端处理接取和放弃。",
    tags: ["系统", "调查", "委托", "界面", "M2"],
    details: [["入口", "右键调查板 · /pm commission board"], ["状态", "可接取 · 进行中 · 已完成 · 锁定 · 冷却"], ["距离", "水平 6 格 · 垂直 4 格"], ["协议", "9 · 14 固定消息 ID"], ["权威端", "服务端"]],
    long: "客户端只发送接取或放弃意图；服务端重新校验调查板距离、案件 ID、当前进度、前置、完成记录和冷却。界面只在收到新的 S2C 权威快照后刷新。" },
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "207 JUnit · 6 GameTest"], ["协议", "9 · 14 固定消息 ID"], ["资源", "266 JSON · 824 双语键"], ["内容图", "114 节点 · 160 关系"], ["迁移", "schema 17 快照 · 精确回滚 · 孤儿保留"], ["专服", "连续启动2次 · 种子/marker幂等 · 保存停服"]],
    long: "Build 工作流在 clean build 后实际执行 6 项 Forge GameTest、隔离恢复演练和两次 Forge 专用服务器启动。脚本确认定义加载、调查板邻近门禁、队伍 SavedData、active_parties/party_members、种子与 schema marker、命令循环和世界强制保存，检测服务端线程致命错误后再干净停服。" },
  { type: "system", id: "lord_of_mysteries:resource_integrity", name: "统一资源完整性门禁", en: "Unified Resource Integrity Gate",
    ...
    details: [["JSON", "266"], ["双语键", "824 对"], ["静态引用", "359"], ["模型", "75"], ["注册", "70 物品 · 5 方块 · 8 实体"]],
