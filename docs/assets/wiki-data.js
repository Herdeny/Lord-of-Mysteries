...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:guide_commands", name: "调查指引命令", en: "Investigator Guide Commands",
    summary: "十二组无需管理员权限的自助命令，覆盖阶段、手账、营地、雾都、委托、资料与验收记录。",
    tags: ["系统", "命令", "引导", "M1"],
    details: [["阶段", "/pm guide · /pm m1check"], ["手账", "/pm handbook [1-9]"], ["状态", "/pm status"], ["探索", "/pm camp · /pm mistcity"], ["委托", "/pm commission list|status|accept|abandon"], ["资料", "/pm rules · /pm items · /pm bestiary · /pm journal"], ["验收", "/pm trial start|status|stop|reset"]],
  ...
  { type: "system", id: "lord_of_mysteries:tutorial_advancements", name: "教程与晋升成就链", en: "Tutorial and Advancement Chain",
    summary: "十九段成就覆盖 M1 主线、四条预研途径晋升和雾都委托序章。",
    tags: ["系统", "成就", "引导", "M1"],
  ...
  { type: "system", id: "lord_of_mysteries:m1_trial_tracker", name: "M1 一小时试炼追踪器", en: "M1 One-Hour Trial Tracker",
    ...
    details: [["命令", "/pm trial start|status|stop|reset"], ["目标", "一小时 · 营地 · 序列7 · 3次狩猎 · 2次扮演 · 风险峰值25"], ["附加", "死亡 · 睡眠恢复 · 守护符消耗"], ["存档", "Capability schema 11"]],
  ...
  { type: "block", id: "lord_of_mysteries:commission_board", name: "雾都委托板", en: "Mist City Commission Board",
    ...
    tags: ["方块", "委托", "雾都", "M2"],
    details: [["交互", "右键"], ["接取顺序", "走失的煤球 → 失踪小队序章"], ["合成", "纸×3 + 云杉木板×4 + 雾都晨报"], ["权限", "普通玩家"]],
    long: "无活动委托时接取推荐案件；有活动委托时尝试完成返回目标并结算，否则显示当前步骤。委托和任务定义来自服务端数据包。" },
  ...
  { type: "item", id: "lord_of_mysteries:bloodstained_notebook", name: "染血调查笔记", en: "Bloodstained Investigation Notes",
    summary: "失踪小队序章的营地证据，读取后写入调查手账。",
    tags: ["物品", "线索", "任务", "M2"],
    details: [["来源", "调查营地 / 任务保底"], ["用途", "序章步骤4"], ["使用", "右键录入知识"]],
    long: "新营地战利品可能直接包含笔记；旧存档营地在活动步骤触发时提供一次任务保底，避免版本升级后卡死。" },
  { type: "item", id: "lord_of_mysteries:burnt_list", name: "烧焦的名单", en: "Burnt List",
    summary: "完成失踪小队序章后的链二钥匙线索。",
    tags: ["物品", "线索", "奖励", "M2"],
    details: [["获得", "失踪小队序章结算"], ["附加报酬", "144 便士 · 事务所声望 +10"], ["后续", "链二尚未开放"]],
    long: "名单证明当前序章已经闭环，但只解锁后续知识，不提前开放消失的收藏家任务链。" },
  { type: "system", id: "lord_of_mysteries:commission_runtime", name: "数据驱动委托与任务状态机", en: "Data-Driven Commission Runtime",
    ...
    details: [["委托", "2"], ["任务链", "2"], ["目标枚举", "15"], ["存档", "Capability schema 11"], ["校验", "双解法 · 引用 · 步骤 ID"]],
    long: "玩家状态保存便士余额、活动委托、任务链、步骤、计数、完成集合和冷却。数据缺失时拒绝接取，避免半成品状态进入存档。" },
  ...
  { type: "system", id: "lord_of_mysteries:missing_squad_prologue", name: "失踪的调查小队·序章", en: "Missing Investigation Squad: Prologue",
    summary: "七步可玩调查纵切，覆盖证据、序列门槛、神秘遭遇与返回结算。",
    tags: ["任务", "调查链", "序章", "M2"],
    details: [["步骤", "7"], ["门槛", "任一序列 9"], ["遭遇", "特殊生物 ×3"], ["报酬", "144 便士 · 声望 +10 · 烧焦名单"]],
    long: "当前序章复用前哨与调查营地完成最小闭环。废弃教堂、神秘学家小屋、记者救援、三解分支、护送和夜袭属于后续半链。" },
  ...
  { type: "world", id: "mist_city_outpost", name: "雾都前哨", en: "Mist City Outpost",
    ...
    tags: ["世界", "结构", "雾都", "委托", "M2"],
    details: [["维度", "主世界"], ["距离", "出生区外 3–5 区块"], ["定位", "/pm mistcity"], ["设施", "委托板 · 档案台 · 照明"], ["兼容", "旧存档补生成"]],
    long: "前哨使用独立 SavedData 记录位置，在目标区块首次加载时生成。它是完整维多利亚镇区前的可玩纵切，不代表报社、教堂、车站和 NPC 已完成。" },
