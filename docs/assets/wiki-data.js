...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:m1_trial_tracker", name: "M1 两小时纵切追踪器", en: "M1 Two-Hour Vertical Slice Tracker",
    ...
    details: [["命令", "/pm trial start|resume|status|report|verify|stop|reset"], ["目标", "两小时 · 营地 · 序列7 · 3次狩猎 · 2次扮演 · 风险25 · 身份 · 反思 · 城市生活"], ["阶段耗时", "营地10分 · 序列9/8/7为30/60/90分 · 身份/反思/生活为100/110/120分"], ["连续性", "重连 · 重启 · 维度往返 · 死亡恢复"], ["存档", "Capability schema 17"]],
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "224 JUnit · 6 GameTest"], ["协议", "11 · 14 固定消息 ID"], ["资源", "266 JSON · 969 双语键"], ["内容图", "114 节点 · 160 关系"], ["迁移", "schema 17 快照 · 精确回滚 · 孤儿保留"], ["专服", "连续启动2次 · 种子/marker幂等 · 保存停服"]],
    long: "Build 工作流在 clean build 后实际执行 6 项 Forge GameTest、隔离恢复演练和两次 Forge 专用服务器启动。脚本确认定义加载、调查板邻近门禁、证据关联/案件恢复/日报/城市服务契约、队伍 SavedData、active_parties/party_members、种子与 schema marker、命令循环和世界强制保存，检测服务端线程致命错误后再干净停服。" },
  { type: "system", id: "lord_of_mysteries:resource_integrity", name: "统一资源完整性门禁", en: "Unified Resource Integrity Gate",
    ...
    details: [["JSON", "266"], ["双语键", "969 对"], ["静态引用", "390"], ["模型", "75"], ["注册", "70 物品 · 5 方块 · 8 实体"]],
  ...
  { type: "system", id: "lord_of_mysteries:commission_runtime", name: "数据驱动委托与任务状态机", en: "Data-Driven Commission Runtime",
    ...
    details: [["委托", "3"], ["任务链", "3"], ["目标枚举", "15"], ["存档", "Capability schema 17 + 队伍 SavedData"], ["合作", "同记分板 2–4 人离线追赶"]],
    long: "玩家状态保存便士余额、活动委托、记者、夜袭、救援路线、城市工作和完成集合；世界级队伍账本保存共享步骤、成员与个人结算。schema 17 修复非法值并持久化特性/扮演 v2/M1 两小时字段，调查合同保护离线恢复钩子与跨文件引用。" },
