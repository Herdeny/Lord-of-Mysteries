...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:dynamic_case_rotation", name: "动态案件轮换", en: "Dynamic Case Rotation",
    summary: "按世界种子和接案时间确定性生成三类八槽位案件，以证物袋、现场、NPC 和报纸提供实体取证及无软锁替代入口。",
    tags: ["系统", "调查", "动态案件", "证据", "复议", "M2"],
    details: [["命令", "/pm case rotation"], ["类型", "失踪者 · 异常物品 · 神秘犯罪"], ["槽位", "主体 · 动机 · 手段 · 地点 · 异常 · 掩饰 · 影响 · 物证"], ["实体取证", "证物袋右键现场 · 右键证人 · 右键报纸"], ["替代入口", "field 兼容 · desk 6 便士"], ["恢复", "/pm case recover 补袋 · 复议压力 -2"], ["结论", "人为掩藏 · 非凡扭曲 · 仪式诱导"], ["多人", "2–4 人共享案件与证物袋阶段"]],
    long: "每日三种案件类型稳定轮换，实例编号、八槽位和真相在跨午夜、重连与服务器重启后保持一致。接案发放绑定实例和阶段的证物袋；玩家在指定地点右键方块采样、右键标签 NPC 记录证词、右键报纸核验档案。field 命令与调查板 desk 保留为兼容和无软锁入口；证物袋可在调查板按阶段补领，结案或放弃自动回收。错误结论进入复议状态，回到真实调查板后可识别伪证并重新提交。" },
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "251 JUnit · 6 GameTest"], ["协议", "12 · 14 固定消息 ID"], ["资源", "269 JSON · 1140 双语键"], ["内容图", "116 节点 · 164 关系"], ["迁移", "schema 19 快照 · 精确回滚 · 孤儿保留"], ["专服", "连续启动2次 · 种子/marker幂等 · 保存停服"]],
  ...
  { type: "system", id: "lord_of_mysteries:resource_integrity", name: "统一资源完整性门禁", en: "Unified Resource Integrity Gate",
    ...
    details: [["JSON", "269"], ["双语键", "1140 对"], ["静态引用", "454"], ["模型", "76"], ["注册", "71 物品 · 5 方块 · 8 实体"]],
  ...
  { type: "system", id: "lord_of_mysteries:v09_content_graph", name: "v0.9 内容图与迁移门禁", en: "v0.9 Content Graph and Migration Gate",
    ...
    details: [["途径", "22 条"], ["序列", "15 个"], ["委托", "4 种"], ["任务链", "4 条 · 15 类目标"], ["图谱", "116 节点 · 164 关系"], ["报告", "孤儿 · 剧透 · 兼容 · 本地化 · 资产"]],
  ...
  { type: "item", id: "lord_of_mysteries:dynamic_evidence_portfolio", name: "轮换案件证物袋", en: "Rotation Evidence Portfolio",
    ...
    details: [["获得", "接取雾都轮换调查"], ["现场", "指定地点右键方块"], ["阶段", "0–3 · 完成后发光"], ["多人", "在线参与者同步"], ["补领", "调查板附近 /pm case recover"], ["回收", "结案或放弃"]],
    long: "证物袋 NBT 记录实例 ID、案件类型、关键物证和归档阶段，但任务权威状态仍在服务端 Capability/队伍账本。旧实例、伪造 NBT 或重复交互不能推进任务；遗失时只补回当前实例及服务端记录阶段。" },
