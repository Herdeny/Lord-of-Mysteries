...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:investigation_board", name: "雾都调查板", en: "Mist City Investigation Board",
    summary: "分页展示案件公告、三案证据档案、关联推理和玩家假说，并由服务端处理全部状态修改。",
    tags: ["系统", "调查", "委托", "界面", "M2"],
  ...
  { type: "system", id: "lord_of_mysteries:city_newspaper", name: "证据档案与雾都晨报", en: "Evidence Archive and Mist City Herald",
    summary: "三案证据记录与世界种子/日期确定的每日头条，把报社轮班连接到调查情报。",
  ...
  { type: "system", id: "lord_of_mysteries:evidence_reasoning_recovery", name: "证据关联与案件恢复", en: "Evidence Reasoning and Case Recovery",
    summary: "把三案证据组织成 12 条逐步揭示的关系、三阶段推理、明确下一步和受调查板保护的关键物品恢复。",
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "239 JUnit · 6 GameTest"], ["协议", "12 · 14 固定消息 ID"], ["资源", "266 JSON · 1014 双语键"], ["内容图", "114 节点 · 160 关系"], ["迁移", "schema 19 快照 · 精确回滚 · 孤儿保留"], ["专服", "连续启动2次 · 种子/marker幂等 · 保存停服"]],
  ...
  { type: "system", id: "lord_of_mysteries:resource_integrity", name: "统一资源完整性门禁", en: "Unified Resource Integrity Gate",
    ...
    details: [["JSON", "266"], ["双语键", "1014 对"], ["静态引用", "424"], ["模型", "75"], ["注册", "70 物品 · 5 方块 · 8 实体"]],
  ...
  { type: "system", id: "lord_of_mysteries:v09_content_graph", name: "v0.9 内容图与迁移门禁", en: "v0.9 Content Graph and Migration Gate",
    ...
    details: [["途径", "22 条"], ["序列", "15 个"], ["委托", "3 种"], ["任务链", "3 条 · 15 类目标"], ["图谱", "114 节点 · 160 关系"], ["报告", "孤儿 · 剧透 · 兼容 · 本地化 · 资产"]],
  ...
  { type: "system", id: "lord_of_mysteries:commission_runtime", name: "数据驱动委托与任务状态机", en: "Data-Driven Commission Runtime",
    ...
    details: [["委托", "3"], ["任务链", "3"], ["目标枚举", "15"], ["存档", "Capability schema 19 + 队伍 SavedData"], ["合作", "同记分板 2–4 人离线追赶"]],
