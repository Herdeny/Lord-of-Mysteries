...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:tutorial_advancements", name: "教程与晋升成就链", en: "Tutorial and Advancement Chain",
    summary: "十七段成就覆盖 M1 主线，以及观众、猎人、偷盗者和学徒预研晋升。",
    tags: ["系统", "成就", "引导", "M1"],
  ...
  { type: "system", id: "lord_of_mysteries:m1_trial_tracker", name: "M1 一小时试炼追踪器", en: "M1 One-Hour Trial Tracker",
    ...
    details: [["命令", "/pm trial start|status|stop|reset"], ["目标", "一小时 · 营地 · 序列7 · 3次狩猎 · 2次扮演 · 风险峰值25"], ["附加", "死亡 · 睡眠恢复 · 守护符消耗"], ["存档", "Capability schema 10"]],
  ...
  { type: "system", id: "lord_of_mysteries:v08_datapack_pipeline", name: "v0.8 数据生产线", en: "v0.8 Datapack Pipeline",
    ...
    tags: ["系统", "数据包", "CSV", "M2"],
    details: [["途径", "docs/pathways_master.csv · 22 条"], ["配方", "docs/recipes_master.csv · 11 条"], ["生成", "scripts/gen_datapack.py"], ["产物", "34 个 JSON"], ["门禁", "Gradle processResources + check"]],
