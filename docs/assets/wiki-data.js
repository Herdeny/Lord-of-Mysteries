...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:guide_commands", name: "调查指引命令", en: "Investigator Guide Commands",
    summary: "十三组无需管理员权限的自助命令，覆盖阶段、手账、营地、雾都、案件地点、委托、资料与验收记录。",
    tags: ["系统", "命令", "引导", "M1"],
    details: [["阶段", "/pm guide · /pm m1check"], ["手账", "/pm handbook [1-9]"], ["状态", "/pm status"], ["探索", "/pm camp · /pm mistcity · /pm case"], ["委托", "/pm commission list|status|accept|abandon"], ["资料", "/pm rules · /pm items · /pm bestiary · /pm journal"], ["验收", "/pm trial start|status|stop|reset"]],
  ...
  { type: "system", id: "lord_of_mysteries:m1_trial_tracker", name: "M1 一小时试炼追踪器", en: "M1 One-Hour Trial Tracker",
    ...
    details: [["命令", "/pm trial start|status|stop|reset"], ["目标", "一小时 · 营地 · 序列7 · 3次狩猎 · 2次扮演 · 风险峰值25"], ["附加", "死亡 · 睡眠恢复 · 守护符消耗"], ["存档", "Capability schema 12"]],
  ...
  { type: "system", id: "lord_of_mysteries:commission_runtime", name: "数据驱动委托与任务状态机", en: "Data-Driven Commission Runtime",
    ...
    details: [["委托", "2"], ["任务链", "2"], ["目标枚举", "15"], ["存档", "Capability schema 12"], ["校验", "双解法 · 引用 · 步骤 ID"]],
    long: "玩家状态保存便士余额、活动委托、任务步骤、记者 UUID、夜袭波次、完成集合和冷却。数据缺失时拒绝接取，避免半成品状态进入存档。" },
  ...
  { type: "system", id: "lord_of_mysteries:missing_squad_prologue", name: "失踪的调查小队·第一阶段", en: "Missing Investigation Squad: Act One",
    ...
    long: "原七步序章之后追加六步以保护旧存档进度。当前第一阶段已经闭环；神秘学家小屋、真假配方与潜入/强攻/占卜三解仍待实现。" },
  { type: "system", id: "lord_of_mysteries:night_defense", name: "雾都三波夜袭", en: "Mist City Three-Wave Night Assault",
    ...
    details: [["波数", "3"], ["触发", "夜间 + 前哨32格"], ["敌人", "僵尸 / 骷髅"], ["隔离", "玩家 UUID 标签"]],
    long: "只有对应玩家的任务追兵会影响波次。当前波是否已生成和下一波时间写入 Capability，重登不会重置整个防守。" },
