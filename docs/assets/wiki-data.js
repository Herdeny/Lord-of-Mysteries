...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:guide_commands", name: "调查指引命令", en: "Investigator Guide Commands",
    summary: "八组无需管理员权限的自助命令，覆盖阶段、状态、营地、规则、物品、生物与日志。",
    tags: ["系统", "命令", "引导", "M1"],
    details: [["阶段", "/pm guide · /pm m1check"], ["状态", "/pm status"], ["探索", "/pm camp"], ["资料", "/pm rules · /pm items · /pm bestiary · /pm journal"]],
    long: "命令只读取服务端权威状态并发送本地化文本，不修改途径、序列或物品。它们为无法通过配方书或按键提示继续推进的玩家提供稳定恢复路径。" },
  ...
  { type: "entity", id: "lord_of_mysteries:shapeshifter_serpent", name: "幻形蛇", en: "Shapeshifter Serpent",
    ...
    tags: ["生物", "材料", "序列7", "M1"],
    details: [["生成", "主世界，权重 8"], ["生命", "18"], ["攻击", "4"], ["掉落", "幻形蛇毒腺"]],
    long: "当前使用洞穴蜘蛛渲染作为功能性占位；接近前保持隐身，发现玩家后显形并追击。" },
  { type: "entity", id: "lord_of_mysteries:spirit_wisp", name: "灵体微光", en: "Spirit Wisp",
    summary: "低权重飞行灵体，每四秒抽取附近玩家灵性，灵性不足会转化为压力。",
    tags: ["生物", "灵体", "材料", "M1"],
    details: [["生成", "主世界，权重 3"], ["生命", "12"], ["吸取", "2 灵性 / 4 秒"], ["掉落", "灵性盐 / 深灰灵体之泪"]],
    long: "灵体微光迫使玩家保留灵性储备。非凡者最多被抽取 2 点灵性；不足部分会增加 1 点失控压力。当前复用恼鬼渲染。" },
  { type: "entity", id: "lord_of_mysteries:ashen_puppet", name: "灰烬傀儡", en: "Ashen Puppet",
    summary: "高生命低移速亡灵，命中会通过灰烬施加虚弱和缓慢。",
    tags: ["生物", "亡灵", "材料", "M1"],
    details: [["生成", "主世界，权重 5"], ["生命", "24"], ["攻击", "5"], ["掉落", "灰烬丝线 / 灰烬粉"]],
    long: "灰烬傀儡承担低序列材料守门者角色。它比普通僵尸更耐打但更慢，攻击附带 5 秒虚弱和 3 秒缓慢；当前复用尸壳渲染。" },
  ...
  { type: "item", id: "lord_of_mysteries:spirit_lantern", name: "灵视提灯", en: "Spirit Lantern",
    summary: "令 16 格内敌对生物显形 10 秒的耐久工具。",
    tags: ["物品", "显形", "灵性", "M1"],
    details: [["范围", "16 格"], ["持续", "10 秒"], ["冷却", "5 秒"], ["耐久", "64"], ["代价", "3 灵性；不足时压力 +2"]],
    long: "提灯对范围内敌对生物施加发光轮廓。非凡者优先支付 3 灵性，普通人或灵性不足者仍可强行使用，但承担 2 点失控压力。" },
