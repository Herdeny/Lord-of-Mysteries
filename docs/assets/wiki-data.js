...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    summary: "用玩家自检、M1/M2 合同、174 项测试和 CI 专服运行诊断保护 M1 连续性与 M2 调查基础。",
    tags: ["系统", "专用服务器", "CI", "诊断", "M1"],
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "174"], ["协议", "6 · 11 个固定 ID"], ["合同", "M1 首小时 · M2 调查/队伍恢复"], ["冒烟", "3委托 · 3任务链 · Done · 保存停服"]],
  ...
  { type: "system", id: "lord_of_mysteries:persistent_party_ledger", name: "持久化队伍调查账本", en: "Persistent Party Investigation Ledger",
    ...
    details: [["命令", "/pm party · /pm party sync"], ["人数", "2–4 · 离线成员计入上限"], ["保存", "步骤 · 计数 · 记者 · 夜袭 · 路线"], ["结算", "货币/声望/冷却逐人"], ["防错", "只前进 · 冲突拒绝 · 全员完成后清理"]],
    long: "主世界 lord_of_mysteries_quest_parties SavedData 按队伍名保存调查快照、成员和已结算集合。已登记成员登录自动恢复，中途加入需主动 sync；5 人以上队伍安全降级为个人进度。" },
