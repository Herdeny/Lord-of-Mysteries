...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:dynamic_case_rotation", name: "动态案件轮换", en: "Dynamic Case Rotation",
    summary: "按世界种子和接案时间确定性生成三类八槽位案件，提供双入口取证、植入式误导、三结论与可恢复复议。",
    tags: ["系统", "调查", "动态案件", "证据", "复议", "M2"],
    details: [["命令", "/pm case rotation"], ["类型", "失踪者 · 异常物品 · 神秘犯罪"], ["槽位", "主体 · 动机 · 手段 · 地点 · 异常 · 掩饰 · 影响 · 物证"], ["取证", "现场 · 证人 · 档案"], ["入口", "field 实地 · desk 6 便士替代"], ["结论", "人为掩藏 · 非凡扭曲 · 仪式诱导"], ["误判", "压力 +6 · reconsider"], ["恢复", "调查板复议 · 压力 -2 · 揭示伪证"], ["多人", "2–4 人共享案件状态"]],
    long: "每日三种案件类型稳定轮换，实例编号、八槽位和真相在跨午夜、重连与服务器重启后保持一致。现场、证人和档案三轮证据均可实地取得，也可在调查板支付 6 便士走 desk 入口；余额不足只增加压力，不会造成软锁。错误结论进入复议状态，回到真实调查板后可识别伪证并重新提交。" },
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "248 JUnit · 6 GameTest"], ["协议", "12 · 14 固定消息 ID"], ["资源", "268 JSON · 1127 双语键"], ["内容图", "116 节点 · 163 关系"], ["迁移", "schema 19 快照 · 精确回滚 · 孤儿保留"], ["专服", "连续启动2次 · 种子/marker幂等 · 保存停服"]],
  ...
  { type: "system", id: "lord_of_mysteries:resource_integrity", name: "统一资源完整性门禁", en: "Unified Resource Integrity Gate",
    ...
    details: [["JSON", "268"], ["双语键", "1127 对"], ["静态引用", "447"], ["模型", "75"], ["注册", "70 物品 · 5 方块 · 8 实体"]],
  ...
  { type: "system", id: "lord_of_mysteries:v09_content_graph", name: "v0.9 内容图与迁移门禁", en: "v0.9 Content Graph and Migration Gate",
    ...
    details: [["途径", "22 条"], ["序列", "15 个"], ["委托", "4 种"], ["任务链", "4 条 · 15 类目标"], ["图谱", "116 节点 · 163 关系"], ["报告", "孤儿 · 剧透 · 兼容 · 本地化 · 资产"]],
