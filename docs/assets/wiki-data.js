...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:guide_commands", name: "调查指引命令", en: "Investigator Guide Commands",
    ...
    tags: ["系统", "命令", "引导", "M1"],
    details: [["下一步", "/pm next · /pm guide next"], ["恢复", "/pm recover · /pm guide recover"], ["反思", "/pm reflect"], ["晋升", "/pm guide · /pm m1check"], ["诊断", "/pm doctor"], ["手账", "/pm handbook [1-9]"], ["探索", "/pm camp · /pm mistcity · /pm case"], ["委托", "/pm commission board|list|status|accept|abandon"], ["验收", "/pm trial start|status|report|verify|stop|reset"]],
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "212 JUnit · 6 GameTest"], ["协议", "10 · 14 固定消息 ID"], ["资源", "266 JSON · 881 双语键"], ["内容图", "114 节点 · 160 关系"], ["迁移", "schema 17 快照 · 精确回滚 · 孤儿保留"], ["专服", "连续启动2次 · 种子/marker幂等 · 保存停服"]],
    long: "Build 工作流在 clean build 后实际执行 6 项 Forge GameTest、隔离恢复演练和两次 Forge 专用服务器启动。脚本确认定义加载、调查板邻近门禁、证据/日报契约、队伍 SavedData、active_parties/party_members、种子与 schema marker、命令循环和世界强制保存，检测服务端线程致命错误后再干净停服。" },
  { type: "system", id: "lord_of_mysteries:resource_integrity", name: "统一资源完整性门禁", en: "Unified Resource Integrity Gate",
    ...
    details: [["JSON", "266"], ["双语键", "881 对"], ["静态引用", "364"], ["模型", "75"], ["注册", "70 物品 · 5 方块 · 8 实体"]],
