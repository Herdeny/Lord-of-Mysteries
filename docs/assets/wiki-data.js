...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:investigation_board", name: "雾都调查板", en: "Mist City Investigation Board",
    summary: "分页展示案件公告、三案证据档案和关联推理，并由服务端处理接取、放弃和证据推导。",
    tags: ["系统", "调查", "委托", "界面", "M2"],
    details: [["入口", "右键调查板 · /pm commission board"], ["页面", "案件公告 · 证据档案 · 关联推理"], ["证据状态", "已确认 · 存在矛盾 · 未取得"], ["阶段", "收集中 · 关联中 · 可结论"], ["距离", "水平 6 格 · 垂直 4 格"], ["协议", "11 · 14 固定消息 ID"], ["权威端", "服务端"]],
    long: "客户端只发送接取或放弃意图；服务端重新校验调查板距离、案件 ID、当前进度、前置、完成记录和冷却，并从任务进度、知识和卷宗 NBT 生成只读证据、关系、理论与下一步快照。" },
  ...
  { type: "system", id: "lord_of_mysteries:evidence_reasoning_recovery", name: "证据关联与案件恢复", en: "Evidence Reasoning and Case Recovery",
    ...
    details: [["阶段", "收集中 · 关联中 · 可结论"], ["关系", "支持 · 矛盾 · 去向"], ["总数", "三案 12 条"], ["分析", "/pm case analyze"], ["档案", "/pm case archive"], ["恢复", "/pm case recover · 必须靠近调查板"], ["安全", "不推进 · 不奖励 · 不复制"]],
    long: "关系两端都已发现后才显示。理论、完整度、证据统计和唯一下一步均由服务端生成。恢复仅补回活动案件中缺失的委托纸，以及真假配方案第 2–4 步缺失的确定性卷宗；已有物品、错误步骤或远程请求不会改变状态。" },
  { type: "system", id: "lord_of_mysteries:case_debrief", name: "结案评价与复盘", en: "Case Debrief and Ratings",
    ...
    details: [["总分", "100"], ["证据", "40"], ["程序", "30"], ["安全", "20"], ["效率", "10"], ["评级", "S · A · B · C · D"], ["档案", "/pm case archive"], ["复盘", "/pm case debrief <案件>"], ["存档", "Capability schema 18"]],
    long: "评分只在服务端确认案件可结算后生成，不修改便士、声望或物品。真假配方会在卷宗回收前记录三项证据和错误判断次数；schema 17 旧档迁移后保留完成状态并显示历史未评级。" },
  ...
  { type: "system", id: "lord_of_mysteries:m1_trial_tracker", name: "M1 两小时纵切追踪器", en: "M1 Two-Hour Vertical Slice Tracker",
    ...
    details: [["命令", "/pm trial start|resume|status|report|verify|stop|reset"], ["目标", "两小时 · 营地 · 序列7 · 3次狩猎 · 2次扮演 · 风险25 · 身份 · 反思 · 城市生活"], ["阶段耗时", "营地10分 · 序列9/8/7为30/60/90分 · 身份/反思/生活为100/110/120分"], ["连续性", "重连 · 重启 · 维度往返 · 死亡恢复"], ["存档", "Capability schema 18"]],
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "229 JUnit · 6 GameTest"], ["协议", "11 · 14 固定消息 ID"], ["资源", "266 JSON · 984 双语键"], ["内容图", "114 节点 · 160 关系"], ["迁移", "schema 18 快照 · 精确回滚 · 孤儿保留"], ["专服", "连续启动2次 · 种子/marker幂等 · 保存停服"]],
    long: "Build 工作流在 clean build 后实际执行 6 项 Forge GameTest、隔离恢复演练和两次 Forge 专用服务器启动。脚本确认定义加载、调查板邻近门禁、证据关联/案件恢复/结案复盘/日报/城市服务契约、队伍 SavedData、active_parties/party_members、种子与 schema marker、命令循环和世界强制保存，检测服务端线程致命错误后再干净停服。" },
  { type: "system", id: "lord_of_mysteries:resource_integrity", name: "统一资源完整性门禁", en: "Unified Resource Integrity Gate",
    ...
    details: [["JSON", "266"], ["双语键", "984 对"], ["静态引用", "400"], ["模型", "75"], ["注册", "70 物品 · 5 方块 · 8 实体"]],
  ...
  { type: "system", id: "lord_of_mysteries:commission_runtime", name: "数据驱动委托与任务状态机", en: "Data-Driven Commission Runtime",
    ...
    details: [["委托", "3"], ["任务链", "3"], ["目标枚举", "15"], ["存档", "Capability schema 18 + 队伍 SavedData"], ["合作", "同记分板 2–4 人离线追赶"]],
    long: "玩家状态保存便士余额、活动委托、记者、夜袭、救援路线、城市工作、完成集合和结案复盘；世界级队伍账本保存共享步骤、成员与个人结算。schema 18 修复非法值并持久化特性/扮演 v2/M1 两小时/案件评级字段，调查合同保护离线恢复钩子与跨文件引用。" },
