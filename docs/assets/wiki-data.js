...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:guide_commands", name: "调查指引命令", en: "Investigator Guide Commands",
    summary: "七组无需管理员权限的自助命令，覆盖阶段、状态、营地、规则、物品与生物。",
    tags: ["系统", "命令", "引导", "M1"],
    details: [["阶段", "/pm guide · /pm m1check"], ["状态", "/pm status"], ["探索", "/pm camp"], ["资料", "/pm rules · /pm items · /pm bestiary"]],
  ...
  { type: "system", id: "lord_of_mysteries:tutorial_advancements", name: "M1 教程成就链", en: "M1 Tutorial Advancement Chain",
    summary: "八段成就从获得手稿一直记录到晋升序列 7 魔术师。",
    tags: ["系统", "成就", "引导", "M1"],
    details: [["起点", "帷幕微动"], ["探索", "跟随指针 / 准备充分的调查员"], ["晋升", "占卜家 / 小丑 / 魔术师"], ["狩猎", "无形之物亦有痕迹"]],
