...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:m1_trial_tracker", name: "M1 一小时试炼追踪器", en: "M1 One-Hour Trial Tracker",
    ...
    details: [["命令", "/pm trial start|resume|status|report|verify|stop|reset"], ["目标", "一小时 · 营地 · 序列7 · 3次狩猎 · 2次扮演 · 风险峰值25"], ["阶段耗时", "营地10分 · 序列9/8/7为25/45/60分"], ["连续性", "重连 · 重启 · 维度往返 · 死亡恢复"], ["存档", "Capability schema 14"]],
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    summary: "用玩家自检、M1 可玩性合同、158 项测试和 CI 专服运行诊断保护 M1 连续性与 M2 前置基础。",
    tags: ["系统", "专用服务器", "CI", "诊断", "M1"],
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "158"], ["协议", "6 · 11 个固定 ID"], ["M1 合同", "60分钟 · 3魔药 · 12补给 · 10命令"], ["冒烟", "定义加载 · Done · list · save-all flush · 干净停服"]],
  ...
  { type: "system", id: "lord_of_mysteries:commission_runtime", name: "数据驱动委托与任务状态机", en: "Data-Driven Commission Runtime",
    ...
    details: [["委托", "2"], ["任务链", "2"], ["目标枚举", "15"], ["存档", "Capability schema 14"], ["合作", "同记分板 2–4 人在线共享"]],
    long: "玩家状态保存便士余额、活动委托、任务步骤、记者 UUID、夜袭波次、完成集合、冷却和 M1 阶段耗时。schema 14 加载时修复非法值与损坏引用；共享任务按最大人数门禁安全降级。" },
