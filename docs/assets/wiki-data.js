...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "202 JUnit · 5 GameTest"], ["协议", "8 · 12 固定消息 ID"], ["资源", "266 JSON · 809 双语键"], ["内容图", "114 节点 · 160 关系"], ["迁移", "schema 17 快照 · 精确回滚 · 孤儿保留"], ["专服", "连续启动2次 · 种子/marker幂等 · 保存停服"]],
    long: "Build 工作流在 clean build 后实际执行 5 项 Forge GameTest、隔离恢复演练和两次 Forge 专用服务器启动。脚本确认定义加载、队伍 SavedData、active_parties/party_members、种子与 schema marker、命令循环和世界强制保存，检测服务端线程致命错误后再干净停服。" },
  { type: "system", id: "lord_of_mysteries:resource_integrity", name: "统一资源完整性门禁", en: "Unified Resource Integrity Gate",
    ...
    details: [["JSON", "266"], ["双语键", "809 对"], ["静态引用", "349"], ["模型", "75"], ["注册", "70 物品 · 5 方块 · 8 实体"]],
