...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:tutorial_advancements", name: "M1 教程成就链", en: "M1 Tutorial Advancement Chain",
    ...
    tags: ["系统", "成就", "引导", "M1"],
    details: [["起点", "帷幕微动"], ["探索", "跟随指针 / 准备充分的调查员"], ["防护", "写在灰烬中的警告"], ["晋升", "占卜家 / 小丑 / 魔术师"], ["狩猎", "无形之物亦有痕迹"]],
    long: "教程成就不替代 M1 的真实平衡验收。最终挑战在玩家实际服用序列 7 魔术师魔药后触发并奖励 300 经验，作为代码纵切到达终点的可见记录。" },
  ...
  { type: "system", id: "lord_of_mysteries:m1_trial_tracker", name: "M1 一小时试炼追踪器", en: "M1 One-Hour Trial Tracker",
    ...
    details: [["命令", "/pm trial start|status|stop|reset"], ["目标", "一小时 · 营地 · 序列7 · 3次狩猎 · 2次扮演 · 风险峰值25"], ["附加", "死亡 · 睡眠恢复 · 守护符消耗"], ["存档", "Capability schema 9"]],
  ...
  { type: "system", id: "lord_of_mysteries:v08_datapack_pipeline", name: "v0.8 数据生产线", en: "v0.8 Datapack Pipeline",
    ...
    tags: ["系统", "数据包", "CSV", "M2"],
    details: [["途径", "docs/pathways_master.csv · 22 条"], ["配方", "docs/recipes_master.csv · 7 条"], ["生成", "scripts/gen_datapack.py"], ["产物", "30 个 JSON"], ["门禁", "Gradle processResources + check"]],
