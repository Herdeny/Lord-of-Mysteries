...
LOM.entries = [
  ...
  { type: "system", id: "lord_of_mysteries:server_validation", name: "专用服务器与运行诊断", en: "Dedicated Server Validation",
    ...
    details: [["诊断", "/pm doctor · /pm servercheck"], ["测试", "202 JUnit · 3 GameTest"], ["协议", "8 · 12 固定消息 ID"], ["资源", "261 JSON · 764 双语键"], ["内容图", "71 节点 · 63 关系"], ["迁移", "schema 16 快照 · DataFix · 孤儿保留"], ["冒烟", "3委托 · 3任务链 · Done · 保存停服"]],
    long: "Build 工作流在 clean build 后实际执行 3 项 Forge GameTest，再启动 Forge 专用服务器。脚本确认定义加载、队伍 SavedData、active_parties/party_members、命令循环和世界强制保存，检测服务端线程致命错误后再干净停服。" },
