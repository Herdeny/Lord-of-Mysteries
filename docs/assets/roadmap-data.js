...
window.LOM_ROADMAP_META = {
  ...
  "milestones": [
    ...
    },
    {
      ...
      "points": [
        ...
        "已完成：Capability schema 30、447 项 JUnit 与 24 项 Forge GameTest 覆盖旧档迁移、隐私隔离、重启持久化、真实世界生物注册、组织门准入/拒绝/黑名单覆盖、秘偶战术跨收纳部署、失败不扣费和M4完整服务器链路",
    ...
    },
    {
      ...
      "points": [
        ...
        "已完成：/pm m4、/pm organization strategy、/pm artifact、双语文案、M4机器合同、447项JUnit、24项Forge GameTest及254条Pages图鉴",
    ...
    },
    {
      ...
      "points": [
        "启动：冻结灵界远征的进入、方向、风险、收益、撤离和断线恢复六段机器合同",
        "灵界航路与方向风险",
        "共享梦境、记忆和退出机制",
        "生态预算与异常天气降级策略"
      ]
  ...
  "scopeTargets": {
    ...
    "repository_evidence_at_0.9.32": {
      ...
      "json_resources": 423,
      "paired_translations": 1830,
      "referenced_translation_keys": 788,
      "item_and_block_models": 139,
      "pages_catalog_entries": 254
    }
  }
};
