...
window.LOM_ROADMAP_META = {
  ...
  "milestones": [
    ...
    },
    {
      ...
      "state": "done",
      "duration_weeks": 10,
      "summary": "30分钟灵界远征、12类实体生态与2–4人组织共享梦境已形成机器可验证的进入、交互、结算和安全恢复闭环。",
      ...
      "points": [
        ...
        "已完成：12类生态实体与生成蛋、观察/援助/避让/交涉四应对、所有者隔离、持久绑定、6种异常天气及低配降级规则",
  ...
  "scopeTargets": {
    ...
    "repository_evidence_at_0.9.35": {
      ...
      "registered_items": 156,
      "registered_blocks": 7,
      "registered_entities": 28,
      ...
      "m5_physical_ecology_entities": 12,
      "m5_ecology_spawn_eggs": 12,
      "m5_shared_dream_dimensions": 1,
      "m5_shared_dream_scenarios": 4,
      "m5_shared_dream_symbols": 8,
      "m5_shared_dream_actions": 4,
      "m5_shared_dream_items": 6,
      "m5_shared_dream_recipes": 6,
      "m5_shared_dream_gametests": 2
    }
  }
};
