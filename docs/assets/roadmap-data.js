  ...
  "milestones": [
    {
      ...
      "points": [
        ...
        "Capability schema 27 与命名 DataFix 链保留原始 NBT、迁移历史、孤儿数据和未来 schema",
        "世界加载前原子快照、幂等 schema marker、受限路径恢复工具和恢复前安全备份",
        "17 项 Forge GameTest 覆盖 Clone、旧档迁移、未来数据隔离、特性守恒、M1 状态、调查板邻近、城市经济、五途径进阶、真实祭坛仪式、五途径能力世界行为、旅行家持续双向远门/命名/黑名单/领地取消/运维撤销、持久秘偶、特性处理工作台、额外负载析出和全服来源重放拒绝",
