...
window.LOM_ROADMAP_META = {
  ...
  "milestones": [
    {
      ...
      "points": [
        ...
        "Capability schema 25 与命名 DataFix 链保留原始 NBT、迁移历史、孤儿数据和未来 schema",
        "世界加载前原子快照、幂等 schema marker、受限路径恢复工具和恢复前安全备份",
        "15 项 Forge GameTest 覆盖 Clone、旧档迁移、未来数据隔离、特性守恒、M1 状态、调查板邻近、城市经济、五途径进阶、真实祭坛仪式、五途径能力世界行为、旅行家持续双向远门与权限、特性处理工作台、额外负载析出和全服来源重放拒绝",
    ...
    },
    {
      ...
      "points": [
        ...
        "已预实现：旅行家可复用原版磁石指南针建立持久空间标记，开启存在 20 秒的跨维度双向远门；玩家以实体穿门作最终同意，支持私人/队伍/公开权限、安全落点、失败退款与 /pm travel 引导",
        ...
        "待完成：完整原典能力组、形体/共享梦境/永久秘偶系统、远门命名/黑名单/领地兼容、最终专属素材生物和途径美术",
  ...
  "scopeTargets": {
    ...
    "repository_evidence_at_0.9.25": {
      ...
      "traveler_spatial_relay_gametests": 2,
      ...
      "json_resources": 322,
      "paired_translations": 1467,
      "referenced_translation_keys": 566,
