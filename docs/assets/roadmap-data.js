...
window.LOM_ROADMAP_META = {
  ...
  "milestones": [
    {
      ...
      "points": [
        ...
        "26 项 Forge GameTest 覆盖 Clone、旧档迁移、未来数据隔离、特性守恒、M1 状态、调查板邻近、城市经济、五途径进阶、真实祭坛仪式、五途径能力世界行为、旅行家持续双向远门/组织门禁、持久秘偶/战术状态、无面人隐私记录、材料生物入世、特性处理、额外负载析出、全服来源重放拒绝、M4多人组织行动/封印物保管，以及M5真实灵界维度/多人航线隔离/六段结算",
    ...
    },
    {
      ...
      "state": "done",
      "duration_weeks": 10,
      "summary": "占卜家、观众、猎人、偷盗者和学徒序列 9–5 已形成机器可验证的生存、调查、战斗、晋升与资源闭环，进入可玩候选和真人互补验收。",
      ...
      "points": [
        ...
        "已完成：Capability schema 30、454 项 JUnit 与 26 项 Forge GameTest 覆盖旧档迁移、隐私隔离、重启持久化、真实世界生物注册、组织门准入/拒绝/黑名单覆盖、秘偶战术跨收纳部署、失败不扣费以及M4/M5完整服务器链路",
    ...
    },
    {
      ...
      "state": "done",
      "duration_weeks": 8,
      "summary": "12个组织、周战略与每日自主行动、三席轮值联络员及24/24件封印物形成机器可玩闭环。",
      "acceptance": "组织行动可独立发生，每件封印物都有保管、泄漏、回收和滥用处理。",
      "points": [
        "已完成：七个教会、五个隐秘组织的公开身份、隐秘单位、教义、资源、领地、关系和行动策略七数据面",
        "已完成：12组织按周独立制定战略，世界种子、游戏日和神秘暴露驱动每日三项行动；无人行动逐日自主结算，跨日停服追赶和跨周结果持久化",
        ...
        "已完成：/pm m4、/pm organization strategy、/pm artifact、双语文案、M4机器合同、454项JUnit、26项Forge GameTest及284条Pages图鉴共享回归",
    ...
    },
    {
      ...
      "state": "active",
      "duration_weeks": 10,
      "summary": "首个30分钟灵界远征闭环已可玩：独立维度、五类投影、六段航路、12类生态遭遇档案与6种异常天气；共享梦境继续实施。",
      "acceptance": "30 分钟灵界远征具备进入、导航、风险、收益和安全退出闭环。",
      "points": [
        "已完成：独立灵界维度、教堂/墓园/剧院/港口/庄园五类语义投影、30分钟时限和六段确定性航路",
        "已完成：灵界罗盘、四方向导航、稳定/漂移风险、遭遇阻塞、材料稳定、完成/提前/紧急三类主动撤离",
        "已完成：12类生态遭遇档案、观察/援助/避让/交涉四应对、6种异常天气及视觉/声音低配降级规则",
        "已完成：航路灯、罗盘、返航符、三类收益及回流配方，失败不扣费、完成后才结算，物品/命令均有双语引导",
        "已完成：主世界SavedData、玩家独立航路、坏档孤儿隔离、超时/虚空/灵界死亡/错误维度/重连安全恢复及26项真实Forge GameTest",
        "实施中：组织共享梦境的明确同意、拒绝/超时/断线/跨维/死亡/退队失败关闭，以及梦境记忆与创伤结算",
        "发布边界：12类遭遇目前是可玩航路档案而非12个独立实体；其实体化、更多天气变体和真人30分钟多人平衡继续跟踪"
      ]
    },
    {
      "id": "M6",
  ...
  "scopeTargets": {
    ...
    "repository_evidence_at_0.9.33": {
      ...
      "m4_organizations": 12,
      "m4_action_types": 6,
      "m4_weekly_strategies": 12,
      "m4_physical_liaisons": 3,
      "m4_artifacts": 24,
      "m4_incident_profiles": 6,
      "json_resources": 457,
      "paired_translations": 1922,
      "referenced_translation_keys": 802,
      "item_and_block_models": 145,
      "pages_catalog_entries": 284,
      "m5_spirit_dimensions": 1,
      "m5_projection_types": 5,
      "m5_route_legs": 6,
      "m5_expedition_duration_ticks": 36000,
      "m5_weather_profiles": 6,
      "m5_encounter_profiles": 12,
      "m5_encounter_actions": 4,
      "m5_route_items": 6,
      "m5_route_recipes": 6,
      "m5_spirit_gametests": 2
    }
  }
};
