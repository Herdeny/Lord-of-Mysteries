...
11. 观众/读心者/心理医生与猎人/挑衅者/纵火家作为 M2 预研路径继续保留。
12. 沿偷盗者或学徒途径晋升至序列 7，验证欺诈/解密或空间/星象团队循环。
13. 用半径 3 八点阵列执行净化封印，验证仪式失败、污染与失控分支。
...
- 中英双语、十七段教程/晋升成就、十二条随机低语、知识本地化、基础配方与原版纹理回退
- M1 一小时验收追踪器：六项目标、三项附加统计、Capability schema 10 持久化
- v0.8 数据生产线：22 途径目录、首批配方 CSV、34 个自动生成资源和 Gradle 门禁
- M2 知识经济入口：四类文书/墨水物品、营地残页和四条调查传闻
- JUnit 5 的 116 项测试覆盖玩家数据、验收进度、手账解锁、能力逻辑、恢复规则、灵性消耗、炼药、仪式、扮演与引导
...
- 五途径序列 9-7 已完成可玩预研；雾都、委托、调查链一、多人一致性矩阵与 schema 冻结仍未实现。
