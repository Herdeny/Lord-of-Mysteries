...
> 当前版本：`0.9.27-1.20.1` · Capability schema 27
...
追踪器独立记录重连、专服重启、维度往返和死亡恢复。状态使用当前 schema 27 保存，并由 17 项 Forge GameTest、全服来源重放拒绝、旅行家命名/双向门/权限/黑名单/领地取消/端点运维、秘偶持久所有权和同一世界双启动专服矩阵验证。
