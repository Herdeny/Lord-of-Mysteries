...
> 当前版本：`0.9.33-1.20.1` · Capability schema 30
...
追踪器独立记录重连、专服重启、维度往返和死亡恢复。状态使用当前schema30保存，并由26项Forge GameTest、全服来源重放拒绝、无面人记录、材料生物入世、旅行家组织双向门、秘偶权威收纳/战术跨部署、M4多人隔离、M5灵界远征和同一世界双启动专服矩阵验证。
