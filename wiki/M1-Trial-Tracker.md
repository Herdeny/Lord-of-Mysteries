...
> 当前版本：`0.9.29-1.20.1` · Capability schema 29
...
追踪器独立记录重连、专服重启、维度往返和死亡恢复。状态使用当前 schema 29 保存，并由 20 项 Forge GameTest、全服来源重放拒绝、无面人记录、材料生物入世、旅行家双向门、秘偶权威收纳和同一世界双启动专服矩阵验证。
