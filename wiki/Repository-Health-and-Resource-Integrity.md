...
- 269 个可解析 JSON；
- 1140 个中英成对翻译键和 454 个静态引用键；
- 发布资源过滤固定使用 UTF-8，Mod 列表中文简介不再受 Windows 系统代码页影响；
- 76 个模型；
- 71 个物品、5 个方块、8 个实体的名称与资源。
...
自动化基线为 251 项 JUnit、6 项 Forge GameTest、v0.9 设计源/116 节点/164 关系内容图、schema 19 迁移与精确回滚、四区 dirty mask、M1/M2 合同、调查板邻近门禁、固定/动态证据关联、证物袋/现场/NPC/报纸实体取证、玩家假说、误判恢复、案件物品恢复、结案复盘、报纸、城市服务契约、资源完整性、Issue/评论编辑时即时执行的 GitHub 文本编码审计、Forge clean build 和两次真实专服
