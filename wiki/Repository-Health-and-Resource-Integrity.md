...
自动化基线为 224 项 JUnit、6 项 Forge GameTest、v0.9 设计源/114 节点内容图、schema 17 迁移与精确回滚、四区 dirty mask、M1/M2 合同、调查板邻近门禁、证据关联/案件恢复/报纸/城市服务契约、资源完整性、Issue/评论编辑时即时执行的 GitHub 文本编码审计、Forge clean build 和两次真实专服
