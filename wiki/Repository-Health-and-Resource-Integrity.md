...
自动化基线覆盖 404 项 JUnit、18 项 Forge GameTest、126 节点/188 关系内容图、schema 28 迁移与精确回滚、M1/M2/M3 合同、正式街区 v2、12 项周指令、五档组织立场、三职业经济、神秘暴露、六种世界事件、五途径无证明拒绝/7→6→5/真实祭坛检查与确认/仪式证明重启与能力世界行为、旅行家双向门/命名/三档权限/黑名单/领地取消/端点运维/NBT/反回弹、秘偶持久所有权/权威收纳/复制拒绝/跨维部署、特性处理工作台、额外负载吸收/析出/重启/重试、全服来源重放拒绝、Pages 191 条图鉴及布局契约、资源完整性、Issue/评论编码审计、Forge clean build 和两次真实专服启动—诊断—保存—停服矩阵。四人八小时 M2、真人死亡/跨维度、秘偶真人跨维/长时区块卸载/离线死亡、五种仪式与负载析出真人平衡、具体领地 Mod 联调和多人互补仍需人工验收。
