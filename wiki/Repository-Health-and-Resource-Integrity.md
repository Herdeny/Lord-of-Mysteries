...
自动化基线覆盖 447 项 JUnit、24 项 Forge GameTest、164 节点/214 关系内容图、schema 30 迁移与精确回滚、M1/M2/M3/M4 合同、既有多人/权限/守恒路径，以及 M4 两玩家组织行动隔离、周战略 SavedData、三席实体联络员、24 件封印物唯一保管、六类事故、离线泄漏、恢复、复制滥用、退役和 SavedData 往返。Pages 现有 254 条图鉴并验证 12 个组织、24 件封印物与普通玩家位置隐私；Forge clean build 和两次真实专服启动—诊断—保存—停服矩阵保持。M2 四人八小时、M3 精确视觉/多人互补，以及 M4 高精美术、专属建筑和长期真人平衡仍需人工验收；具体领地 Mod 联调归入 M7。
