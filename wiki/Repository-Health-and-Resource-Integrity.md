...
自动化基线为 308 项 JUnit、6 项 Forge GameTest、v0.9 设计源/116 节点/168 关系内容图、schema 22 迁移与精确回滚、四区 dirty mask、M1/M2 合同、调查板邻近门禁、固定/动态证据关联、案件相关人/受影响者/可视物证、四类封存样本、七日组织轮值、六项周指令、八案历史、结案后续、四联系人态度、24 条事件账本、三类两阶段组织响应、主体关系/日程、组织反馈、跨队实例隔离、25 槽并发现场、配方卷宗绑定、每队独立护送、任务物防复制、队伍变更续玩、证物袋/NPC/报纸实体取证、玩家假说、误判恢复、案件物品恢复、结案复盘、报纸、城市服务契约、资源完整性、Issue/评论编辑时即时执行的 GitHub 文本编码审计、Forge clean build 和两次真实专服
