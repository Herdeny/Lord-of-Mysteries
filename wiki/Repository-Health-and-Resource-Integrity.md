...
> 当前版本：0.9.22-1.20.1 · Capability schema 23 · 内容 schema v4 · 网络协议 12
...
- 320 个可解析 JSON；
- 1421 个中英成对翻译键和 553 个静态引用键；
- 发布资源过滤固定使用 UTF-8，Mod 列表中文简介不再受 Windows 系统代码页影响；
- 97 个模型；
- 90 个物品、7 个方块、8 个实体的名称与资源。
...
自动化基线覆盖 360 项 JUnit、12 项 Forge GameTest、126 节点/188 关系内容图、schema 23 迁移与精确回滚、M1/M2/M3 合同、正式街区 v2、12 项周指令、五档组织立场、三职业经济、神秘暴露、六种世界事件、五途径无证明拒绝/7→6→5/真实祭坛检查与确认/仪式证明重启与能力世界行为、旅行家多人远门、特性处理工作台、Pages 注册图鉴及布局契约、资源完整性、Issue/评论编码审计、Forge clean build 和两次真实专服启动—诊断—保存—停服矩阵。四人八小时 M2、真人死亡/跨维度、五种仪式材料/风险平衡与多人互补仍需人工验收。
