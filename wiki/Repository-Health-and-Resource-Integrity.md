...
自动化基线为 340 项 JUnit、9 项 Forge GameTest、126 节点/188 关系内容图、schema 23 迁移与精确回滚、M1/M2/M3 合同、正式街区 v2、12 项周指令、五档组织立场、三职业经济、神秘暴露、六种世界事件、五途径 7→6→5 晋升重启与能力世界行为、Pages 85 物品/5 方块/8 实体注册图鉴及页面布局契约、资源完整性、Issue/评论编码审计、Forge clean build 和两次真实专服启动—诊断—保存—停服矩阵。四人八小时 M2、真人死亡/跨维度、M3 专属仪式与多人互补仍需人工验收。
