...
> 当前版本：0.9.29-1.20.1 · Capability schema 29 · 内容 schema v4 · 网络协议 13
...
自动化基线覆盖 416 项 JUnit、20 项 Forge GameTest、126 节点/188 关系内容图、schema 29 迁移与精确回滚、M1/M2/M3 合同、正式街区 v2、12 项周指令、五档组织立场、三职业经济、神秘暴露、六种世界事件、五途径最终材料/无证明拒绝/7→6→5/真实祭坛/能力世界行为、无面人隐私记录、七种材料生物入世、旅行家双向门、秘偶权威收纳、特性处理、额外负载、全服来源重放拒绝、Pages 217 条图鉴及布局契约、资源完整性、Issue/评论编码审计、Forge clean build 和两次真实专服启动—诊断—保存—停服矩阵。四人八小时 M2、真人死亡/跨维度、精确视觉身份、秘偶真人跨维/长时区块卸载/离线死亡、五种仪式与负载析出真人平衡、具体领地 Mod 联调和多人互补仍需人工验收。
