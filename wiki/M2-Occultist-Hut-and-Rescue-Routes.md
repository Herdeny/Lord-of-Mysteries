...
> 当前版本：0.9.30-1.20.1 · v0.9 M2 调查与生活
...
小屋距离出生区约 8–10 区块，旧世界会补生成。莫尔被清除或卷宗丢失后均可自动恢复，避免永久卡步。卷宗绑定玩家 UUID 与接取 tick，其他玩家、旧案件或未绑定卷宗不能读取或结算当前答案；背包满时不会向世界掉落，清出空间后再恢复。
...
路线会锁定到当前委托并同步给 2–4 名同队玩家；队伍持久账本支持离线追赶，结算或放弃按成员处理。护送使用队伍专属记者，两队并行、换队或拆队不会争抢同一实体；旧公共记者存档会自动迁移。已登记账本后来扩容时原 1–4 人仍可继续，第 5 人保持独立。Capability schema 30 保证死亡、重登、跨维度和服务器保存后仍能恢复，并保留个人联系人记忆、组织响应、城市班次、暴露、特性来源盐、远门权限/组织/黑名单、秘偶编队/权威收纳与无面人形体。
