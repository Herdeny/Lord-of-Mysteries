...
> 当前版本：0.9.17-1.20.1 · v0.9 M2 调查与生活
...
路线会锁定到当前委托并同步给 2–4 名同队玩家；队伍持久账本支持离线追赶，结算或放弃按成员处理。护送使用队伍专属记者，两队并行、换队或拆队不会争抢同一实体；旧公共记者存档会自动迁移。已登记账本后来扩容时原 1–4 人仍可继续，第 5 人保持独立。Capability schema 22 保证死亡、重登、跨维度和服务器保存后仍能恢复，并保留个人联系人记忆与组织响应分支。
