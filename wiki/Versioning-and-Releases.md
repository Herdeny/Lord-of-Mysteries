...
- Pages 工作流发布 `docs/`。
- Pages 图鉴由注册表、12 份组织定义、24 份封印物定义和双语文件生成；手工条目只能补充能力/系统说明，不能替代当前 132 物品、7 方块、16 实体覆盖检查。
...
- 自动化基线为 447 项 JUnit、24 项真实 Forge GameTest、164 节点/214 关系内容图、423 JSON、1830 对双语键、788 个静态引用、139 个模型、132 个物品、7 个方块和 16 个实体。
