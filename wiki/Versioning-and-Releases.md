...
- 当前版本：**`0.9.30-1.20.1`**
- 开发阶段：**v0.9 M3 首发五途径可玩候选与组织/编队治理**（M3）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-30 05:49:30 UTC+01:00**（`2026-07-30T04:49:30Z`）
<!-- project-status:end -->
...
- Pages 工作流发布 `docs/`。
- Pages 图鉴由注册表和双语文件生成；手工条目只能补充能力/系统说明，不能替代当前 109 物品、7 方块、16 实体覆盖检查。
