...
| M5 | Spirit world and dreams | 已完成 | 30分钟灵界远征、12类实体生态与2–4人组织共享梦境已形成机器可验证的进入、交互、结算和安全恢复闭环。 |
| M6 | Second pathway wave | 进行中 | 水手、不眠者、收尸人和歌颂者序列 9–5。 |
...
| 生命周期回归 | 464 JUnit、28 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
...
| M5 机器完成 | 两种独立维度、五类投影、六段航路、6天气、12实体生态、2–4人明确同意共享梦境和逐人恢复 | done / release evidence pending |
| 构建门禁 | 设计源、生成器、内容图、合同、资源、Gradle、回滚与双启动专服 | verified automation |

## M0/M1 完成结论

- M0：164 节点/214 关系内容图、schema 30 迁移链、精确回滚、来源审计和 CI 门禁完成。
...
- M5：机器可玩范围完成；专属实体美术、更多途径梦境与真人30分钟多人平衡继续单独跟踪。
- M6：当前里程碑，开始准备水手、不眠者、收尸人和歌颂者序列9–5及其与灵界/梦境的交叉验收。
