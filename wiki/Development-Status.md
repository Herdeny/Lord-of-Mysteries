...
- 当前版本：**`0.9.10-1.20.1`**
- 开发阶段：**v0.9 M2 动态案件轮换与误判复议**（M2）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-19 00:50:36 UTC+01:00**（`2026-07-18T23:50:36Z`）
<!-- project-status:end -->
...
| 内容图 | 116 节点、163 关系、6 类报告 | verified |
...
| 生命周期回归 | 248 JUnit、6 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
| M2 调查板 | 分页案件、四案证据档案、17 条稳定关系、三阶段推理、下一步、关键物品恢复与服务端邻近校验 | code_ready |
| M2 动态案件 | 三类日轮换、八槽位、三轮双入口、植入式误导、三结论、误判复议与持久队伍共享 | code_ready |
...
- M0：116 节点内容图、schema 19 迁移链、精确回滚、来源审计和 CI 门禁完成。
...
- M2：当前进行中；调查板、四案证据、关联推理、玩家假说、误判恢复、案件物品恢复、结案评级、每日报纸、首批城市服务和第一版八槽位动态案件已完成，继续建设正式城市街区、经济、动态槽位实体化与四人八小时无锁死验收。
