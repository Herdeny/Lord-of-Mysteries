...
| 生命周期回归 | 360 JUnit、12 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
...
| 非凡特性 | 分层序列、纯度、印记、污染、来源哈希、永久失控精确掉落，以及工作台拆分/重组/封存/洗涤 | code_ready |
| 扮演 v2 | 身份卡、反思日志、原则理解、过度认同、每日反思与 UI | verified |
| 既有玩法 | 五途径 9–7、4 委托、4 任务链、持久队伍 | playable migration assets |
| M3 首批 | 五途径序列 6–5、10 瓶魔药、20 项服务端能力、20 项扮演事件、五种专属仪式、旅行家磁石同行远门、非凡特性加工与无证明拒绝/重启 GameTest | code_ready |
...
- M3：五途径 9–7 已可玩，序列 6–5、五种专属晋升仪式、旅行家磁石同行远门和非凡特性加工已达 `code_ready`；完整能力系统、最终专属资源和多人互补矩阵未完成。
