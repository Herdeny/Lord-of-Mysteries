...
- 当前版本：**`0.9.9-1.20.1`**
- 开发阶段：**v0.9 M2 玩家假说与误判恢复**（M2）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-18 22:55:14 UTC+01:00**（`2026-07-18T21:55:14Z`）
<!-- project-status:end -->
...
| 生命周期回归 | 239 JUnit、6 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
| M2 调查板 | 分页案件、三案证据档案、12 条稳定关系、三阶段推理、下一步、关键物品恢复与服务端邻近校验 | code_ready |
...
- M0：114 节点内容图、schema 19 迁移链、精确回滚、来源审计和 CI 门禁完成。
...
- M2：当前进行中；调查板、三案证据、关联推理、玩家假说、误判恢复、案件物品恢复、结案评级、每日报纸和首批城市服务已完成，继续建设正式城市街区、经济、动态案件和四人八小时无锁死验收。
