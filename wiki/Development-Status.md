...
| 玩家迁移 | schema 0/15/16→17 DataFix、世界快照、精确恢复、原始 NBT 备份与孤儿保留 | verified |
| 状态同步 | 四区 dirty mask、生命周期核心摘要、5 秒校正、协议 10 与调查/证据快照 | code_ready |
| 生命周期回归 | 212 JUnit、6 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
| M2 调查板 | 分页案件、三案证据档案、报酬/状态/步骤、邻近校验与服务端接取/放弃 | code_ready |
...
- M0：114 节点内容图、schema 17 迁移、精确回滚、来源审计和 CI 门禁完成。
...
- M2：当前进行中；调查板、三案证据档案与每日报纸已完成，继续建设正式报社/事务所/警局、证据推理、经济、动态案件和四人八小时无锁死验收。
