...
本地化调查日志、九章神秘学手账、十三段教程/晋升成就、Capability schema 9 六目标试炼追踪器、生物弱点反制和指引命令已完成；
一小时生存、死亡/重连和专用服务器平衡记录仍是验收缺口。
观众/猎人序列 9–7、偷盗者/学徒序列 9 与通用仪式底座作为后续阶段预研保留。

M2 已开始预研：22 途径 CSV 主表、30 个生成资源、知识经济与四条调查传闻已经落地。
偷盗者/学徒保持 `m2_foundation`，但序列 9 的魔药、能力、六项扮演、知识副本与独立失控体已可玩。
观众/猎人序列 9-7 已形成完整预研纵切，序列 7 含魔药、七项扮演、能力和独立失控体。
