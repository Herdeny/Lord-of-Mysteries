...
- 当前版本：**`0.8.9-1.20.1`**
- 开发阶段：**M1 人工验收 / M2 可玩预研**（M1）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-17 14:57:12 UTC+01:00**（`2026-07-17T13:57:12Z`）
<!-- project-status:end -->
...
本地化调查日志、九章神秘学手账、二十一段教程/晋升成就、十二项保底首小时补给、动态阶段提示与引导物恢复、
Capability schema 15 自修复、四阶段耗时报告、六目标 + 四连续性试炼追踪器、`/pm doctor`、协议 6 限流、
183 项测试、M1/M2 合同、统一资源完整性、持久化队伍恢复与专用服务器运行诊断—命令循环—强制保存—停服冒烟已完成；
真实一小时生存和平衡记录仍是验收缺口。
...
轻量雾都前哨、委托板、事务所便士账本、3 种委托、3 条任务链、四名 NPC、废弃教堂、邪教营地、
神秘学家小屋、真假配方、三解救援、记者护送和三波夜袭已经可玩；
...
- 完整雾都镇区、正式警戒 AI/剧情演出、正式队伍 GUI、多人负载矩阵与 M2 schema 冻结仍待实现。
- 专用像素美术仍待制作。
