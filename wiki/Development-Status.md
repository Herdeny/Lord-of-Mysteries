...
- 当前版本：**`0.9.29-1.20.1`**
- 开发阶段：**v0.9 M3 首发五途径可玩候选与专属材料生态**（M3）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-30 04:24:25 UTC+01:00**（`2026-07-30T03:24:25Z`）
<!-- project-status:end -->
...
| M3 | Five launch pathways | 进行中 | 占卜家、观众、猎人、偷盗者和学徒序列 9–5 已形成机器可验证的生存、调查、战斗、晋升与资源闭环，进入可玩候选和真人互补验收。 |
...
| 玩家迁移 | schema 0/15–28→29 DataFix、世界快照、精确恢复、原始 NBT 备份、无面人记录清洗与孤儿保留 | verified |
| 状态同步 | 四区 dirty mask、生命周期核心摘要、5 秒校正、协议 13、额外负载与调查/证据/推理/假说快照 | code_ready |
| 生命周期回归 | 416 JUnit、20 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
...
| M2 玩家假说 | 160 字有界说明、三种立场、误判压力/负担、纠正/复议恢复与 schema 29 持久化 | code_ready |
...
| 非凡特性 | 分层序列、纯度、印记、污染、来源哈希、永久失控精确掉落、工作台加工、额外负载、危险吸收与活体析出 | code_ready |
| 扮演 v2 | 身份卡、反思日志、原则理解、过度认同、每日反思与 UI | verified |
| 既有玩法 | 五途径 9–7、4 委托、4 任务链、持久队伍 | playable migration assets |
| M3 可玩候选 | 五途径序列 6–5、10 瓶魔药、10 种最终材料、7 种材料生物、20 项服务端能力、20 项扮演事件、五种专属仪式、无面人八槽形体、旅行家双向门、三槽持久秘偶、特性加工及 20 项真实 GameTest | playable candidate |
| 构建门禁 | 设计源、生成器、内容图、合同、资源、Gradle、回滚与双启动专服 | verified automation |

## M0/M1 完成结论

- M0：126 节点/188 关系内容图、schema 29 迁移链、精确回滚、来源审计和 CI 门禁完成。
...
- M3：当前正式里程碑。五途径 9–5 已接入最终材料、生物生态、晋升仪式、无面人形体、旅行家远门、秘偶编队/收纳、非凡特性加工和额外负载析出；精确视觉身份、完整原典能力穷举、具体领地 Mod 适配器、组织门权限、高精美术和多人互补长测仍是发布边界。
