...
- 当前版本：**`0.9.21-1.20.1`**
- 开发阶段：**v0.9 M2 真人验收准备与 M3 旅行家空间标记远门**（M2）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-25 14:56:05 UTC+01:00**（`2026-07-25T13:56:05Z`）
<!-- project-status:end -->
...
| 生命周期回归 | 352 JUnit、11 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
...
| M3 首批 | 五途径序列 6–5、10 瓶魔药、20 项服务端能力、20 项扮演事件、五种专属仪式、旅行家磁石同行远门与无证明拒绝/重启 GameTest | code_ready |
...
- M3：五途径 9–7 已可玩，序列 6–5、五种专属晋升仪式和旅行家磁石同行远门已达 `code_ready`；完整能力系统、最终专属资源和多人互补矩阵未完成。
