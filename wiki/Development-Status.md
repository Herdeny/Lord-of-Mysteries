...
| 生命周期回归 | 260 JUnit、6 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
| M2 调查板 | 分页案件、四案证据档案、17 条稳定关系、三阶段推理、下一步、关键物品恢复与服务端邻近校验 | code_ready |
| M2 动态案件 | 三类日轮换、八槽位、案件相关人/受影响者、可视物证、四类封存样本、证物袋/NPC/报纸取证、替代入口、误判复议与持久队伍共享 | code_ready |
...
- M2：当前进行中；调查板、四案证据、关联推理、玩家假说、误判恢复、案件物品恢复、结案评级、每日报纸、首批城市服务、八槽位动态案件、案件相关人/受影响者、可视物证及四类封存样本已完成，继续建设正式城市街区、经济、角色关系/日程、周级调度与四人八小时无锁死验收。
