...
- 当前版本：**`0.9.14-1.20.1`**
- 开发阶段：**v0.9 M2 单人/多人稳定性、实例隔离与任务物恢复**（M2）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-24 04:58:04 UTC+01:00**（`2026-07-24T03:58:04Z`）
<!-- project-status:end -->
...
| 生命周期回归 | 272 JUnit、6 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
| M2 调查板 | 分页案件、四案证据档案、19 条稳定关系、三阶段推理、下一步、关键物品恢复与服务端邻近校验 | code_ready |
| M2 动态案件 | 三类日轮换、七日组织轮值、八槽位、主体关系/四段日程、案件相关人/受影响者、可视物证、四类封存样本、证物袋/NPC/报纸取证、组织评级反馈、替代入口、误判复议与持久队伍共享 | code_ready |
...
- M0：116 节点/168 关系内容图、schema 19 迁移链、精确回滚、来源审计和 CI 门禁完成。
...
- M2：当前进行中；调查板、四案证据、关联推理、玩家假说、误判恢复、案件物品恢复、结案评级、每日报纸、首批城市服务、八槽位动态案件、案件相关人/受影响者、可视物证、四类封存样本、七日组织轮值、主体关系/日程及组织反馈已完成，继续建设正式城市街区、经济、多角色关系演化、组织反应任务、扩展周级案件池与四人八小时无锁死验收。
