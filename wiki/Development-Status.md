...
| 生命周期回归 | 377 JUnit、14 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
...
| M2 玩家假说 | 160 字有界说明、三种立场、误判压力/负担、纠正/复议恢复与 schema 24 持久化 | code_ready |
...
| M3 首批 | 五途径序列 6–5、10 瓶魔药、20 项服务端能力、20 项扮演事件、五种专属仪式、旅行家远门、特性加工、额外负载与无证明拒绝/重启/析出 GameTest | code_ready |
