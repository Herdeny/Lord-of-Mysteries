...
| 状态同步 | 四区 dirty mask、生命周期核心摘要、5 秒校正、协议 9 与调查板快照 | code_ready |
| 生命周期回归 | 207 JUnit、6 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
| M2 调查板 | 分页案件、报酬/状态/步骤、邻近校验与服务端接取/放弃 | code_ready |
...
- M2：当前进行中；调查板案件入口已完成，继续建设正式报社/事务所/警局、经济、三个动态案件和四人八小时无锁死验收。
