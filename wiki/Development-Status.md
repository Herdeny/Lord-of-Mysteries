...
| 内容图 | 147 节点、197 关系、6 类报告；含 12 组织、7 封印物与两类 M4 知识门 | verified |
...
| 生命周期回归 | 439 JUnit、24 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
...
| M4 首批可玩 | 12个组织七数据面、每日3项/6类自主行动、玩家独立任务、7/24件封印物、世界级唯一保管、离线泄漏、换手回收、复制隔离、稳定/归还/退役与Pages图鉴 | active / first playable loop |
| 构建门禁 | 设计源、生成器、内容图、合同、资源、Gradle、回滚与双启动专服 | verified automation |

## M0/M1 完成结论

- M0：147 节点/197 关系内容图、schema 30 迁移链、精确回滚、来源审计和 CI 门禁完成。
...
- M4：当前正式里程碑。首批12组织、6类自主行动和7件封印物形成可玩闭环；完整24件逐件验证、组织据点/NPC日程、跨周战略、知识发现链和真人多人平衡继续实施。
