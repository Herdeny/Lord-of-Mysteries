...
- 当前版本：**`0.9.26-1.20.1`**
- 开发阶段：**v0.9 M2 真人验收准备与 M3 远门安全兼容闭环**（M2）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-26 01:11:40 UTC+01:00**（`2026-07-26T00:11:40Z`）
<!-- project-status:end -->
...
| 生命周期回归 | 392 JUnit、16 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
...
| M2 玩家假说 | 160 字有界说明、三种立场、误判压力/负担、纠正/复议恢复与 schema 26 持久化 | code_ready |
