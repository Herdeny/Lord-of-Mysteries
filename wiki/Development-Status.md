...
- 当前版本：**`0.9.16-1.20.1`**
- 开发阶段：**v0.9 M2 实体组织响应任务与联系人态度演化**（M2）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-24 14:58:31 UTC+01:00**（`2026-07-24T13:58:31Z`）
<!-- project-status:end -->
...
| 玩家迁移 | schema 0/15/16/17/18/19/20→21 DataFix、世界快照、精确恢复、原始 NBT 备份与孤儿保留 | verified |
| 状态同步 | 四区 dirty mask、生命周期核心摘要、5 秒校正、协议 12 与调查/证据/推理/假说快照 | code_ready |
| 生命周期回归 | 295 JUnit、6 Forge GameTest、隔离回滚与两次专服启动矩阵 | verified automation |
| M2 调查板 | 分页案件、四案证据档案、19 条稳定关系、三阶段推理、下一步、关键物品恢复与服务端邻近校验 | code_ready |
| M2 动态案件 | 三类日轮换、七日组织轮值、六项周指令、八案历史、三类结案后续、四联系人态度、两阶段实体组织响应、八槽位、主体关系/四段日程、案件角色/物证、实体取证、组织评级反馈、替代入口、误判复议与持久队伍共享 | code_ready |
| M2 玩家假说 | 160 字有界说明、三种立场、误判压力/负担、纠正/复议恢复与 schema 21 持久化 | code_ready |
...
- M0：116 节点/168 关系内容图、schema 21 迁移链、精确回滚、来源审计和 CI 门禁完成。
...
- M2：当前进行中；调查板、四案证据、关联推理、玩家假说、误判恢复、案件物品恢复、结案评级、每日报纸、首批城市服务、八槽位动态案件、案件角色/物证、七日组织轮值、六项周指令、八案历史、三类结案后续、四联系人态度、两阶段实体组织响应、主体关系/日程及组织反馈已完成，继续建设正式城市街区、经济、跨案件联系人记忆、分支组织任务、扩展周级案件池与四人八小时无锁死验收。
