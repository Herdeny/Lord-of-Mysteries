...
- Core/Knowledge/Social/Endgame 四区 dirty mask、生命周期摘要同步和 11 项 Forge GameTest 已进入 CI。
...
五条途径的序列 9–7 已可玩。序列 6–5 新增无面人/秘偶大师、催眠师/梦境行者、阴谋家/收割者、盗火人/窃梦家、记录官/旅行家，共 10 瓶魔药、20 项能力和 20 项扮演事件；五种晋升仪式与旅行家磁石同行远门已经 `code_ready`。完整原典系统、专属生物/材料和真人平衡尚未完成，不能标记 M3 完成。
...
- M3 序列 6–5、五种专属晋升仪式与旅行家磁石同行远门已达 `code_ready`；完整原典能力组、持续双向门、专属资源和组队互补矩阵仍在建设。
