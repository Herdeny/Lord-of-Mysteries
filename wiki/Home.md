...
| 加工非凡特性 | [拆分、重组、封存与洗涤](M3-Characteristic-Processing) |
...
- Core/Knowledge/Social/Endgame 四区 dirty mask、生命周期摘要同步和 12 项 Forge GameTest 已进入 CI。
...
五条途径的序列 9–7 已可玩。序列 6–5 新增无面人/秘偶大师、催眠师/梦境行者、阴谋家/收割者、盗火人/窃梦家、记录官/旅行家，共 10 瓶魔药、20 项能力和 20 项扮演事件；五种晋升仪式、旅行家磁石同行远门与非凡特性加工已经 `code_ready`。完整原典系统、专属生物/材料和真人平衡尚未完成，不能标记 M3 完成。
...
- `/pm characteristic`：查看特性拆分、重组、封存、洗涤、数值代价和失败安全规则。
...
- 特性 bundle 已完成永久失控转移、精确死亡掉落、拆分、同途径重组、直接同源拒绝、封存和洗涤；活体额外负荷提取、全局来源账本与跨途径高阶规则继续后置。
...
- M3 序列 6–5、五种专属晋升仪式、旅行家磁石同行远门与非凡特性加工已达 `code_ready`；完整原典能力组、持续双向门、专属资源和组队互补矩阵仍在建设。
