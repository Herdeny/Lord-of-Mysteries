...
能力、扮演、生物、确定性新手营地、野外风险工具、九章神秘学手账、教程成就、六项目标 + 四项连续性试炼追踪器、
`/pm doctor`、152 项测试与专用服务器启动—保存—停服冒烟已经完成；真实一小时生存和平衡记录仍待验收。
...
- **试炼追踪**：自动记录六项核心目标与重连、重启、跨维度、死亡恢复四项连续性门禁；暂停只累计在线时间。
...
- 中英双语、二十段教程/晋升成就、十二条随机低语、152 项单元/契约测试和 Forge 专服 CI 冒烟。
