...
- 最后更新：**2026-07-06 08:19:52 UTC+01:00**（`2026-07-06T07:19:52Z`）
<!-- project-status:end -->
...
观众/猎人序列 9-7、偷盗者/学徒序列 9 与通用仪式底座作为后续阶段
...
- **M2 预研**：22 途径 CSV、30 个生成资源、知识经济、观众/猎人 9-7 与偷盗者/学徒序列 9 可玩纵切。
...
- 偷盗者：`Y` 妙手空空、潜行触发潜影步、`U` 应急脱身；玩家行窃默认关闭。
- 学徒：`V` 灵性视野、`Y` 小空间戏法、`U` 稳定灵墨知识副本。
- 两条途径各有三项扮演事件、独立失控体、图鉴、掉落和晋升成就。
- 详细玩法见 [偷盗者与学徒序列 9](M2-Sequence-9-Foundation)。
...
- 中英双语、十三段教程/晋升成就、十二条随机低语、103 项单元测试和完整 CI 检查。
