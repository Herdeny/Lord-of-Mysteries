...
- 玩家 Capability 升至 schema 21，旧 schema 15/16/17/18/19/20 存档自动迁移并回填 M1 状态、空结案归档、空假说工作区、空动态案件历史、联系人账本与组织响应任务槽。
- 世界加载前创建 schema 21 快照；恢复工具支持 dry-run、清单校验、恢复前安全备份、精确替换与路径穿越拒绝。
...
自动化已经验证 116 节点/168 关系内容图、295 项 JUnit、6 项 Forge GameTest、精确回滚和两次真实专服启动。真人两小时节奏、死亡/跨维度与多人长时记录继续作为发布前回归证据，而不再阻塞路线进入 M2。
...
- 轮换案件实体证物袋、案件相关人、受影响者、可视物证、四类封存样本、七日组织轮值、六项周指令、主体关系/日程、八案历史、三类结案后续、四联系人态度、组织 NPC 简报、调查板响应提交、组织声望反馈、标签 NPC 证词、报纸档案核验、调查板补领和队伍阶段同步。
...
- M2 调查板、四案证据/关联推理、玩家假说与误判恢复、持久化结案评分、每日报纸、前哨三类服务台、八槽位动态案件、案件角色/物证、七日组织轮值、六项周指令、八案历史、四联系人态度与两阶段实体组织响应已完成；正式城市结构、完整经济、跨案件联系人记忆、分支组织任务、原创物证美术与扩展周级案件池仍在建设。
