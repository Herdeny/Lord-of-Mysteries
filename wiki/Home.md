...
- 当前版本：**`0.9.6-1.20.1`**
- 开发阶段：**v0.9 M2 城市服务台与功能区**（M2）
- 技术基线：Minecraft **1.20.1** · Forge **47.4.20** · Java **17**
- 最后更新：**2026-07-18 09:30:28 UTC+01:00**（`2026-07-18T08:30:28Z`）
<!-- project-status:end -->
...
- 网络协议升至 10，14 个固定消息 ID 分离状态面板、周期核心摘要与调查/证据快照。
...
- M2 调查板、三案证据档案、每日报纸和前哨三类服务台已完成；正式城市结构、证据关联推理、完整经济和三个动态案件仍在建设。
