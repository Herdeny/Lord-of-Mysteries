...
- 当前内容图包含 116 节点、163 关系，并输出孤儿、剧透、兼容、本地化与资产报告。
...
自动化已经验证 116 节点/163 关系内容图、248 项 JUnit、精确回滚和两次真实专服启动。真人两小时节奏、死亡/跨维度与多人长时记录继续作为发布前回归证据，而不再阻塞路线进入 M2。
...
- M2 调查板、四案证据/关联推理、玩家假说与误判恢复、持久化结案评分、每日报纸、前哨三类服务台和第一版八槽位动态案件已完成；正式城市结构、完整经济、真实物证/NPC 落地与周级案件调度仍在建设。
