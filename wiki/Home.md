...
能力、扮演、生物、确定性新手营地、野外风险工具、教程成就、试炼追踪器与指引命令已经完成；
...
- 九段教程成就、`/pm m1check`、`/pm trial` 与本地化调查日志共同标记纵切进度。
...
- **调查命令**：`/pm guide`、`status`、`camp`、`m1check`、`rules`、`items`、`bestiary`、`journal`、`trial`。
- **试炼追踪**：自动记录一小时、营地、晋升、狩猎、风险峰值以及死亡/恢复/守护符统计。
...
- 中英双语、九段教程成就、十二条随机低语、84 项单元测试和完整 CI 检查。
