...
自动化已经验证 116 节点/168 关系内容图、272 项 JUnit、6 项 Forge GameTest、精确回滚和两次真实专服启动。真人两小时节奏、死亡/跨维度与多人长时记录继续作为发布前回归证据，而不再阻塞路线进入 M2。
...
- 轮换案件实体证物袋、案件相关人、受影响者、可视物证、四类封存样本、七日组织轮值、主体关系/日程、组织声望反馈、标签 NPC 证词、报纸档案核验、调查板补领和队伍阶段同步。
...
- M2 调查板、四案证据/关联推理、玩家假说与误判恢复、持久化结案评分、每日报纸、前哨三类服务台、八槽位动态案件、案件相关人/受影响者、可视物证、四类封存样本、七日组织轮值、主体关系/日程与组织反馈已完成；正式城市结构、完整经济、多角色关系演化、组织反应任务、原创物证美术与扩展周级案件池仍在建设。
