...
- Core/Knowledge/Social/Endgame 四区 dirty mask、生命周期摘要同步和 9 项 Forge GameTest 已进入 CI。
...
自动化基线为 126 节点/188 关系内容图、340 项 JUnit、9 项 Forge GameTest、精确回滚和两次真实专服启动。M2 的四人八小时真人矩阵仍是里程碑关闭门禁；M3 的专属仪式、完整能力组和多人互补也不能由机器计数替代。
