...
> 当前版本：0.9.28-1.20.1 · Capability schema 28 · 网络协议 13
...
- 404 项 JUnit、18 项 Forge GameTest、M2 合同、旅行家双向门命名/权限/黑名单/领地事件/端点运维、秘偶持久编队/权威收纳/复制拒绝、全服来源重放拒绝、回滚与双启动专服矩阵保护该流程。
